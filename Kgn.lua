-- KGN GUI Completo:
-- - Interface principal (menu original)
-- - Botões no canto direito para ligar/desligar ESP e AIMBOT (independentemente do menu)
-- - ESP e AIMBOT só funcionam contra jogadores de times diferentes
-- - AIMBOT normal (mira no inimigo mais próximo)
-- - Sem Anti Kick/Ban
